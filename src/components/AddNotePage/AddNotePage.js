        ...
        <div className="gallery">
          ...
          <section className="right-field_info gallery-right">
            <img className="img-3"
                 ...
                 alt="note" />
            <img className="img-4"
                 src="https://images.pexels.com/photos/230629/pexels-photo-230629.jpeg?cs=srgb&dl=pexels-dianne-230629.jpg&fm=jpg"
                 alt="note" />
            <img className="img-5"
                 src="https://images.pexels.com/photos/1659438/pexels-photo-1659438.jpeg?cs=srgb&dl=pexels-marius-venter-1659438.jpg&fm=jpg"
                 alt="note" />
          </section>
        </div>
      </div>
